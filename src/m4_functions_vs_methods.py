...
def try_methods():
    ...
    ###########################################################################
    tommy = rg.SimpleTurtle()
    tommy.pen = rg.Pen('brown', 5)
...
def try_methods_and_functions():
    ...
    robert.pen = rg.Pen('blue', 5)

    robert.backward(150)
    robert.speed = 1

    draw_many_squares(robert, 2, 100, 30)

    robert.speed = 5
    robert.pen = rg.Pen('red', 5)

    draw_many_squares(robert, 10, 50, 15)

    robert.speed = 100
    robert.pen = rg.Pen('red', 35)

    draw_many_squares(robert, 8, 300, 60)

    robert.pen = rg.Pen('black', 3)

    robert.backward(200)

    robert.draw_circle(30)

    robert.draw_square(50)
